...
Acesse: Elementor > Templates > Theme Builder
Adicione novo > Header
Desenhe seu header personalizado
Defina condições de exibição: "Entire Site"
Publique
Desativar Header Padrão: Adicione no functions.php:
...
Traduzir com Poedit
Abra languages/cogitari-tec.pot no Poedit
Traduza as strings
...
Este é um tema proprietário desenvolvido exclusivamente para Cogitari Tec. Uso não autorizado é proibido.
